	...
	return (
		<div className="px-6 lg:px-24 flex flex-col md:flex-row justify-between mb-8 gap-10 mt-6 items-start">
			<input
				...
				className="w-full max-w-[550px]  text-black/50 sm:w-1/2 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
				value={search}
